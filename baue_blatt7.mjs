...
const band = (paintedId, leben, kraft, art = "werte") => {
  ...
  const h = -H;   /* negativ = nach unten: der Sockel haengt unter der Bodenkante */
...
<div class="schirm">
  ...
  <div class="blatt"><div class="rumpf">
    <div class="buehne">
      ...
      <div class="werte">
        <div class="wert">${zeichen("bandRot", KLINGE_STRICH)}<div><div class="z" style="color:#ffb3aa">${atk}</div><div class="w" style="color:#e08a84">Angriff</div></div><div class="naechste"><b>+1</b><span>nächste</span></div></div>
        <div class="wert">${zeichen("bandBlau", HERZ_STRICH)}<div><div class="z" style="color:#b6cdff">${hp}</div><div class="w" style="color:#8ba6e0">Leben</div></div><div class="naechste"><b>+1</b><span>nächste</span></div></div>
      </div>
...
.figur{width:148px;height:150px;position:relative;top:-12px}
...
<div class="marke">Entwurf 7 · der Sockel hängt jetzt unter der Bodenkante
  <small>Gemessen: das Band stand bei ALLEN 69 Figuren über den gemalten Ring hinaus — beim Springer 29, beim Händler 61, bei der Schatzkammer 88 Bildpixel. Genau das war die Kante. Jetzt hängt der Sockel darunter, die Figur rutscht mit.</small></div>
<div class="reihen">
...
fs.writeFileSync("/mnt/user-data/outputs/entwurf-figurenblatt-7.html", html);
...
await p.goto("file://" + path.resolve("/mnt/user-data/outputs/entwurf-figurenblatt-7.html"), { waitUntil: "load" });
await p.waitForTimeout(600);
await p.screenshot({ path: "/mnt/user-data/outputs/entwurf-figurenblatt-7.png", fullPage: true });
