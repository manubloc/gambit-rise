...
export const ABZEICHEN_DEFS = `
 ...
 <radialGradient id="sa-emaille" cx=".5" cy=".5" r=".55"><stop offset="0" stop-color="#000" stop-opacity="0"/><stop offset=".72" stop-color="#000" stop-opacity=".1"/><stop offset="1" stop-color="#000" stop-opacity=".48"/></radialGradient>
 ...
 <filter id="sa-maser" x="0" y="0" width="1" height="1"><feTurbulence type="fractalNoise" baseFrequency=".035 .5" numOctaves="3" seed="7"/><feColorMatrix type="saturate" values="0"/><feComponentTransfer><feFuncA type="table" tableValues="0 .24"/></feComponentTransfer><feComposite in2="SourceGraphic" operator="in"/></filter>
