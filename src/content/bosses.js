...
export const BOSSES = [
  ...
  B("b05", "Der Streuner",     "The Prowler",     "beast",   "#ff8a4c",  17, 7, { leaps: ZEBRA }, { flavorDe: "Er gehört niemandem und keinem Ort — er folgt dem Riss wie andere dem Wasser.", flavorEn: "He belongs to no one and no place — he follows the rift as others follow water.", abilities: ["blenden", "gift", "wegelagerei"] }),  // 9->8
  ...
  B("b08", "Kanonier",         "Cannoneer",       "golem",   "#ffd166", 16, 8, { slides: ORTHO, range: 3 }, { flavorDe: "Er zählt bis drei und die Mauer fällt; er hat nie weiter zählen müssen.", flavorEn: "He counts to three and the wall falls; he has never needed to count further.", aura: { type: "courtHp", n: 2 }, abilities: ["wegelagerei", "steinhaut", "schrecken", "blenden", "widerhall"] }),  // 10->9
  B("b09", "Skorpion",         "Scorpion",        "serpent", "#f472b6",  16, 8, { leaps: [...sym(2, 2), ...ORTHO] }, { flavorDe: "Sein Stich schmerzt nicht sofort — das ist das Heimtückische daran.", flavorEn: "His sting does not hurt at once — that is the treachery of it.", abilities: ["gift", "aderlass", "schrecken"] }),
